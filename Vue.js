...
// Vue.prototype.PLATFORM_TEST = process.env.NODE_ENV == "development" ? "http://localhost:3002" : "http://api-platform-test.99jobs.com"
...
Vue.prototype.OPPORTUNITIES_ENDPOINT =
  'http://staging-api-oportunidades.99jobs.com';

// Only console if DEV
process.env.NODE_ENV == 'development' &&
  console.log('API_ENDPOINT = ' + Vue.prototype.API_ENDPOINT);
process.env.NODE_ENV == 'development' &&
  console.log('DELTA_ENDPOINT = ' + Vue.prototype.DELTA_ENDPOINT);
process.env.NODE_ENV == 'development' &&
  console.log(
    'OPPORTUNITIES_ENDPOINT = ' + Vue.prototype.OPPORTUNITIES_ENDPOINT
  );
